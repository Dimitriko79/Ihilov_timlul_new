    ...
    <div className="relative">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {copied ? (
              ...
              <span className="flex items-center gap-1">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m0 0h2a2 2 0 012 2v3m2 4H10m0 0l3-3m-3 3l3 3"></path></svg>                העתקה
              </span>
            )}
          </button>
      ...
      <div className="group relative h-[45vh] w-full overflow-hidden" style={{ resize: 'vertical' }}>
        ...
        <div className="absolute bottom-2 right-2 w-6 cursor-ns-resize opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" class="w-4 h-4 text-gray-400"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 13l-7 7-7-7m14-8l-7 7-7-7"></path></svg>        </div>
      </div>
    </div>
  );
};
